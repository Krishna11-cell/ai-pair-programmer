...
### Security
- Removed `console.log` that exposed Groq API key in developer console
- Added `data/` to `.gitignore` to prevent tracking review memory

## [1.0.4] - 2026-06-06

### Changed
- Updated README installation section to include both marketplace install and build-from-source steps
